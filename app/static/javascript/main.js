...
(function() {
  ...
  Width = React.createClass({
    ...
    componentDidMount: function() {
      ...
      return window.addEventListener("click", this.handleClick);
    },
    render: function() {
      return d.p({}, this.state.width);
    }
  });
  ...
  DiceView = React.createClass({
    ...
    authDropbox: function(e) {
      e.preventDefault();
      return dbclient.authenticate(updateAuthenticationStatus);
    },
    render: function() {
      var index, items;
      ...
      }, "Save"), !dbclient.isAuthenticated() ? d.button({
        type: "button",
        className: "btn btn-default",
        onClick: this.authDropbox
      }, "Login") : void 0)));
    }
  });
  ...
  $(function() {
    return React.render(Page({}), document.getElementById('container'));
  });
